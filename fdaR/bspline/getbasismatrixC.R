getbasismatrixC <- function(evalarg, basisobj, nderiv=0) {
...
if (type == "bspline") {
    ...
    dyn.load("/Users/Harry/Documents/MATLAB/fdaR-Harry/bspline/bsplineC.so")
   	basismat <- .Call("bsplineC", evalarg, breaks, norder, nderiv)
