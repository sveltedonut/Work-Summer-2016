...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    #define NREP1       prhs[5]
    #define NREP2       prhs[6]
    #define FDOBJ1      prhs[7]
    #define FDOBJ2      prhs[8]
    #define LFDOBJ1     prhs[9]
    #define LFDOBJ2     prhs[10]
    #define WTFD        prhs[11]
    #define EPS         prhs[12]
    
    double *rngi, width, *rngvec, *fx1, *fx2, n;
    ...
    // initialize JMAX and calculate JMAXP
    ...
    double *y, *x;
    double delta, dy, ho, hp, errval, ssqval, crit, eps;
    ...
    Y_OUT   = mxCreateDoubleMatrix(nrep1, nrep2, mxREAL);
    y       = mxGetPr(Y_OUT);
